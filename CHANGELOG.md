...
- Add misc coverage tests for client, profiles, websocket
- Lift coverage above 80% via CLI + tool invocation tests
...
- spline-mcp: Bump tool-config pins from 3.13 to 3.14
- spline-mcp: Uv python pin 3.14
